...
A pergunta descreve o que a agenda publicou. Uma data listada não prova que o show aconteceu. O jogo mostra esse aviso junto da resposta em telas largas, no "Como jogar" e no painel "Ver fonte" do resultado.
...
O progresso da rodada fica no `localStorage` do navegador, na chave `kpop-map-<data da rodada>`, com os MBIDs dos eventos da rodada, o país escolhido em cada data e a data na tela. Recarregar a página retoma a pergunta ou o resultado. Um registro de outra rodada, com país fora da lista ou com contagens impossíveis é descartado. No fim, a barra mostra o placar ("7 de 10 certas."), "Compartilhar resultado", "Jogar outra rodada" e "Ver fonte", que lista cada data com o país correto, a resposta do jogador, o link da agenda com o local na fonte, o evento no MusicBrainz, a revisão do Wikidata usada para o país e a data de conferência.
