...
const catalogs: Record<Locale, Messages> = {
  "pt-BR": {
    ...
    mapHowToPlay: [
      "Leia a data da turnê e escolha o país destacado no mapa ou o nome dele na lista. Em telas largas, a lista fica ao lado do mapa; em telas menores, fica na barra de baixo, com o botão \"Responder\".",
      ...
      "No fim, \"Ver fonte\" lista as 10 datas com a sua resposta e as fontes de cada uma. Uma data na agenda não confirma que o show aconteceu.",
    ],
  ...
  en: {
    ...
    mapHowToPlay: [
      "Read the tour date and pick the highlighted country on the map or its name in the list. On wide screens the list sits beside the map; on smaller screens it sits in the bar at the bottom, with the \"Answer\" button.",
      ...
      "At the end, \"Show source\" lists the 10 dates with your answer and the sources for each. A date on the schedule does not confirm that the show took place.",
    ],
