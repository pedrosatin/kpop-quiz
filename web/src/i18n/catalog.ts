...
const catalogs: Record<Locale, Messages> = {
  ...
  en: {
    ...
    consentText:
      "We use Cloudflare Web Analytics to measure site usage without cookies. If you agree, Google Analytics will also use cookies and identifiers for audience statistics.",
